...
public class CajaS {
	private Palabra32bits[] arreglo = new Palabra32bits[256];

	public CajaS(int numeroCajaS) {
		for(int i = 0; i < arreglo.length; i++) {
			switch(numeroCajaS) {
			case 1:
				arreglo = Palabra32bits.intToPalabra(sbox_init_1);
				break;
			case 2:
				arreglo = Palabra32bits.intToPalabra(sbox_init_2);
				break;
			case 3:
				arreglo = Palabra32bits.intToPalabra(sbox_init_3);
				break;
			case 4:
				arreglo = Palabra32bits.intToPalabra(sbox_init_4);
				break;
			}
		}
	}
